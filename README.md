...
## Carlos README (TODO: Clean this README.md)

From:

```docker pull nvcr.io/nvidia/pytorch:22.04-py3```

Install (using /usr/bin/python3.8 and the corresponding pip)
...
cd ~/Argoverse2_Motion_Forecasting/lightning_logs && python -m tensorboard.main --logdir . --port=6100
