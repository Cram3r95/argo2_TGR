...
class TMFModel(pl.LightningModule):
    ...
    def init_args(parent_parser):
        ...
        parser_model.add_argument("--mod_full_unfreeze_epoch", type=int, default=50)
    ...
    def configure_optimizers(self):
        if self.args.freeze_decoder:
            ...
            scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer,
                                                                   ...
                                                                   # patience=math.ceil(self.args.num_epochs/20),
                                                                   patience=5,
                                                                   min_lr=1e-6,
                                                                   verbose=True)
...
class DecoderResidual(nn.Module):
    ...
    def forward(self, decoder_in, is_frozen):
        ...
        if self.args.freeze_decoder:
            ...
            return decoder_out, [] # There are no confidences in this case
