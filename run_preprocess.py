...
class ModifiedArgoverseMap(ArgoverseMap):
    def __init__(self):
        super(ModifiedArgoverseMap, self).__init__f()
...
"""
python run_preprocess.py --dataroot /home/robesafe/Argoverse2_Motion_Forecasting/dataset/argoverse \
--mode val --save-dir /home/robesafe/CGHFormer/preprocessed_with_wimp_argo2 --social-features \
